...
public class RegisterActivity extends AppCompatActivity implements FirebaseAuth.AuthStateListener {
    ...
    Uri pickedImgUri;
    private EditText userEmail, userPassword, userPAssword2, userName, cin;
...
private void signIn(){
    ...
    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
        if (firebaseAuth.getCurrentUser() != null) {
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Adherents").child(mAuth.getCurrentUser().getUid());
            ObjectAdherent = new Adherent(userEmail.getText().toString(), userName.getText().toString(), cin.getText().toString());
            ref.setValue(ObjectAdherent);
